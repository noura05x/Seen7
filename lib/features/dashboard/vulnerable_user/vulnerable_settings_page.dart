...
class VulnerableSettingsPage extends StatelessWidget {
  const VulnerableSettingsPage({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              lang.text(
                en: "Manage your account, preferences, and support options.",
                ar: "إدارة الحساب والتفضيلات وخيارات الدعم.",
              ),
